...
#constructors  function in python

"""class Wealth:
    def __init__(self):
        print("hello i am constructor funtion")
        print(self)

obj = Wealth()  # whenever you call a class this function will run automatically
Wealth()  """
